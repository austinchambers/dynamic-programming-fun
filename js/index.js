...
function displayTable(table, gridMaxRows, gridMaxCols) {
...
function main() {
    ...
    setHelpfulText("You're right. This doesn't work. Try using our floating table");
